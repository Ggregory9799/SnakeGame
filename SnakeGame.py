...
# Here we import our required modules
from tkinter import *
import random

# This defines the dimensions of the game board
WIDTH = 500
HEIGHT = 500
SPACE_SIZE = 20
...
SPEED = 250
BODY_SIZE= 2
# Determines the color of the snake "Green"
SNAKE = "#00FF00"
# Color of food "White"
FOOD = "#FFFFFF"
...
# This is to define the snake as an object in the game
class Snake:
...
# This will define the food as an object in the game
class Food:

    def __init__(self):

        # Generates the food location randomly
        x = random.randint(0,
